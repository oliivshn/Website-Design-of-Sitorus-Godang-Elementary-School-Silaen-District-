	...
	<div class="page-content">
		<div class="page-bar">
			<div class="page-title-breadcrumb">
				<div class=" pull-left">
					<div class="page-title">Tambah Mapel</div>
				</div>
															...
															<div class="form-group">
																...
																<div class="col-sm-6">
																	<select class="form-control @error('matapelajaran') is-invalid @enderror" id="matapelajaran" name="matapelajaran">
																		...
																		@foreach ($jadwal1 as $rowkelas1)
																		<option value="{{ $rowkelas1->nama_matapelajaran }}">{{ $rowkelas1->nama_matapelajaran }}</option>
																		@endforeach
																	</select>
																	@error('matapelajaran')
																	<div class="alert alert-danger my-3 col-sm-6" role="alert">
	...
	$(document).ready(function() {
		$('form').submit(function(e) {
			...
			if (isValid) {
				...
				swal({
					title: "Berhasil",
					text: "Jadwal Kelas 1 Berhasil Ditambahkan!",
					icon: "success",
				}).then(function() {
					form.submit();
				});
