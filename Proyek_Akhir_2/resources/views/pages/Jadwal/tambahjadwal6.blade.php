		...
		<div class="row">
			<div class="col-md-12">
				<div class="tabbable-line">
					...
					<form action="/insertdata6" method="post" enctype="multipart/form-data">
						@csrf
															...
															<div class="form-group">
																...
																<div class="col-sm-6">
																	<select class="form-control @error('matapelajaran') is-invalid @enderror" id="matapelajaran" name="matapelajaran">
																		...
																		@foreach ($jadwal6 as $rowkelas6)
																		<option value="{{ $rowkelas6->nama_matapelajaran }}">{{ $rowkelas6->nama_matapelajaran }}</option>
																		@endforeach
																	</select>
																	@error('matapelajaran')
																	<div class="alert alert-danger my-3 col-sm-6" role="alert">
    ...
    $(document).ready(function() {
        $('form').submit(function(e) {
            ...
            if (isValid) {
                ...
                swal({
                    title: "Berhasil",
                    text: "Jadwal Kelas 6 Berhasil Ditambahkan!",
                    icon: "success",
                }).then(function() {
                    form.submit();
                });
