										...
										<div class="card-body ">
											<div class="row">
												<div class="col-md-6 col-sm-6 col-6">
													...
													<div class="btn-group">
														<a href="/tambahkelas4" id="addRow" class="btn btn-primary">
															Tambah Jadwal <i class="fa fa-plus"></i>
														</a>
													</div>
													@endif
													<div class="btn-group">
														<a href="/exportpdfjadwal4" id="addRow" class="btn btn-danger">
											...
											<table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle" id="example4">
												...
												<tbody>
													...
													$hariData = [];
													$counter = 1;
													foreach($data4 as $rowkelas4) {
													$hariData[$rowkelas4->hari][] = $rowkelas4;
													}
													$maxRows = count($data4) > 0 ? max(array_map('count', $hariData)) : 0;
													@endphp
													...
													@for ($i = 0; $i < $maxRows; $i++) <tr>
														...
														<td style="text-align: center;">
															...
															<br>
															@if (Auth::check() && Auth::user()->role == 'admin')
															<a href="{{ url('edit-murid4', $rowData->id) }}" class="btn btn-sm btn-outline-success" title="Edit">
...
<script>
	$('.delete').click(function() {
		var kelas4id = $(this).attr('data-id');
		swal({
				title: "Apakah Anda Yakin?",
				text: "Anda Akan Menghapus Jadwal Kelas 4",
				icon: "warning",
				buttons: true,
				dangerMode: true,
			})
			.then((willDelete) => {
				if (willDelete) {
					window.location = "/delete4/" + kelas4id;
