    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title">Raport Siswa Kelas 4</div>
                </div>
            ...
            <div class="col-md-13">
                <div class="tabbable-line">
                    ...
                    <ul class="nav customtab nav-tabs" role="tablist">
                        <li class="nav-item"><a href="#tab1" class="nav-link active" data-bs-toggle="tab">Raport Kelas 4</a></li>
                    </ul>
                                        ...
                                        <div class="card-body ">
                                            <div class="row">
                                                ...
                                                @if(Auth::check() && Auth::user()->role == 'admin')
                                                    <div class="btn-group">
                                                        <a href="{{ route('tambah4') }}" id="addRow" class="btn btn-primary">
                                                            Tambah Nilai <i class="fa fa-plus"></i>
                                                        </a>
                                                    </div>
                                                    @endif
                                                    <div class="btn-group">
                                                        <a href="/exportpdf4" id="addRow" class="btn btn-danger">
                                            ...
                                            <table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle" id="example4">
                                                <thead>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                <a href="{{ route('editraport4', ['id' => $row->id]) }}" id="addRow" class="btn btn-success">
...
<script>
    $('.delete').click(function() {
        var raport4id = $(this).attr('data-id');
        swal({
                title: "Apakah Anda Yakin?",
                text: "Anda Akan Menghapus Raport Kelas 4 Tersebut",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            })
            .then((willDelete) => {
                if (willDelete) {
                    window.location = "/deleteraport4/" + raport4id;
