    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title">Raport Siswa Kelas 6</div>
                </div>
            ...
            <div class="col-md-13">
                <div class="tabbable-line">
                    ...
                    <ul class="nav customtab nav-tabs" role="tablist">
                        <li class="nav-item"><a href="#tab1" class="nav-link active" data-bs-toggle="tab">Raport Kelas 6</a></li>
                    </ul>
                                            ...
                                            <table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle" id="example4">
                                                <thead>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                <a href="{{ route('editraport6', ['id' => $row->id]) }}" id="addRow" class="btn btn-success">
...
<script>
    $('.delete').click(function() {
        var raport6id = $(this).attr('data-id');
        swal({
                title: "Apakah Anda Yakin?",
                text: "Anda Akan Menghapus Raport Kelas 6 Tersebut",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            })
            .then((willDelete) => {
                if (willDelete) {
                    window.location = "/deleteraport6/" + raport6id;
