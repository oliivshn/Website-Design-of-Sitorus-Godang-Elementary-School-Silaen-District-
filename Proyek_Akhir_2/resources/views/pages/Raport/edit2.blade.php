		...
		<div class="row">
			<div class="col-md-12">
				<div class="tabbable-line">
					...
					<form action="{{ url('update-raport2', $edit2->id) }}" method="post" enctype="multipart/form-data">
						@csrf
													...
													<form class="form-horizontal">
														<fieldset>
															...
															<div class="form-group">
																...
																<div class="col-sm-6">
																	<input type="text" name="tugas" id="tugas" class="form-control" placeholder="Masukkan Nilai Tugas" value="{{ $edit2->tugas }}">
																	@error('tugas')
															...
															<div class="form-group">
																...
																<div class="col-sm-6">
																	<input type="text" name="ujian" id="ujian" class="form-control" placeholder="Masukkan Nilai Ujian" value="{{ $edit2->ujian }}">
																	@error('ujian')
																	<div class="alert alert-danger my-3 col-sm-6" role="alert">
																		{{ $message }}
																	</div>
															...
															<div class="form-group">
																...
																<div class="col-sm-6">
																	<input type="text" name="kkm" id="kkm" class="form-control" placeholder="Masukkan KKM" value="{{ $edit2->kkm }}">
																	@error('kkm')
																	<div class="alert alert-danger my-3 col-sm-6" role="alert">
																		{{ $message }}
																	</div>
															...
															<div class="form-group">
																...
																<div class="col-sm-6">
																	<input type="text" name="uts" id="uts" class="form-control" placeholder="Masukkan Nilai UTS" value="{{ $edit2->uts }}">
																	@error('uts')
																	<div class="alert alert-danger my-3 col-sm-6" role="alert">
																		{{ $message }}
																	</div>
                                                            ...
                                                            <div class="form-group">
																...
																<div class="col-sm-6">
																	<input type="text" name="uas" id="uas" class="form-control" placeholder="Masukkan Nilai UAS" value="{{ $edit2->uas }}">
																	@error('uas')
																	<div class="alert alert-danger my-3 col-sm-6" role="alert">
																		{{ $message }}
																	</div>
															...
															<div class="form-group">
																...
																<div class="col-sm-6">
																	<input type="text" name="jumlah_nilai" id="jumlah_nilai" class="form-control" placeholder="Masukkan Nilai Raport" value="{{ $edit2->jumlah_nilai }}">
																	@error('jumlah_nilai')
																	<div class="alert alert-danger my-3 col-sm-6" role="alert">
																		{{ $message }}
																	</div>
