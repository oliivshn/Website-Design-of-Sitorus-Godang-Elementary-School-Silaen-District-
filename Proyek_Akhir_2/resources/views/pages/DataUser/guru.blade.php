											...
											<table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle" id="example4">
												...
												<tbody>
													...
													<tr class="odd gradeX">
														...
														@if (Auth::user()->jabatan === 'Kepala Sekolah')
														<td>
															<a href="{{ route('editteachers', $row->id) }}" class="tblEditBtn">
...
<script>
	$('.delete').click(function() {
		...
		swal({
				...
				text: "Anda Akan Menghapus Data Guru Tersebut",
				icon: "warning",
				buttons: true,
				dangerMode: true,
			})
			.then((willDelete) => {
				if (willDelete) {
					window.location = "/deleteteacher/" + teacherid;
