    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title">Tambah Kepala Sekolah</div>
                </div>
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <li class="active">Tambah Kepala Sekolah</li>
                </ol>
            </div>
        </div>
        <div class="row">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                            <input id="password" type="password" name="password" placeholder="Kata Sandi" class="form-control" autocomplete="new-password">
                                                                            @error('password')
                                                                            <div class="alert alert-danger my-3 col-sm-6" role="alert">
                                                                                {{ $message }}
                                                                            </div>
    ...
    $(document).ready(function() {
        $('form').submit(function(e) {
            ...
            if (isValid) {
                ...
                swal({
                    title: "Berhasil",
                    text: "Kepala Sekolah Berhasil Ditambahkan!",
                    icon: "success",
                }).then(function() {
                    form.submit();
                });
