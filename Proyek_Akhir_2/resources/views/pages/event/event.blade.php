      ...
      <div class="right">
        ...
        <div class="add-event-wrapper">
          <div class="add-event-header">
            <div class="title">Tambah Agenda</div>
            <i class="fas fa-times close"></i>
          </div>
          <div class="add-event-body">
            <div class="add-event-input">
              <input type="text" placeholder="Judul Agenda" class="event-name" />
            </div>
            <div class="add-event-input">
...
<script>
  ...
  if (e.target.classList.contains("event")) {
    <?php if (Auth::check() && Auth::user()->role === 'admin'): ?>
      if (confirm("Apakah Kamu Yakin Menghapus Agenda Tersebut?")) {
    ...
    <?php else: ?>
      // Menampilkan pesan akses ditolak jika pengguna tidak memiliki peran 'admin'
